...
export function TestMovieButton() {
  return (
    <div className="flex flex-col gap-4 p-8">
      ...
      <button
        className="bg-movie-primary text-black font-saira font-bold uppercase tracking-wide
      ...
      <button
        className="bg-movie-secondary text-white font-saira font-semibold
      ...
      >
        <h3 className="text-movie-text font-saira text-2xl font-bold mb-3
                       uppercase tracking-wider text-shadow-[0_0_20px_rgba(255,255,255,0.5)]">
          What Happens Next?
        </h3>
        <p className="text-movie-text-muted font-saira text-sm leading-relaxed">
      ...
      <div className="border-2 border-movie-accent rounded-lg p-4">
        <p className="text-movie-text font-saira text-sm">
